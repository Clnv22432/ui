        ...
        <div className="col">
            <div className="main">
                <div className="row justify-content-center">
                    ...
                    <div className="col-2">
                        <div className="card bg-light"style={{width: 150}} >
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text"><span className="name12">Bakery: items</span></p>
                    ...
                    <div className="col-2">
                        <div className="card bg-light" style={{width: 130}}>
                    ...
                    <div className="col-2">
                        <div className="card bg-light" style={{width: 150}}>
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text"><span className="name12">Cleaner</span></p>
